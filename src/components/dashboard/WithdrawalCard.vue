<template>
	<button
		class="w-full bg-[#2D3035] flex gap-[16px] justify-between items-center text-left p-[20px] mb-[20px]"
		@click="$emit('withdrawAction')"
	>
		<div class="basis-3/4">
			<h5 class="text-[16px] font-medium text-white uppercase">
				{{ props.title }}
			</h5>
