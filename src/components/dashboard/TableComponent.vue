<template>
    ...
    <div class="grid grid-cols-12 px-[20px] my-[25px]">
        ...
        <div class="col-span-5">
            <div class="bg-black text-white text-[16px] border border-[#2D3035] focus:outline-none py-[12px] pl-[28px] pr-[12px] flex items-center gap-x-[24px]">
                <img src="@/assets/img/Search.svg" alt="" />
                <input type="text" placeholder="Search by name" aria-label="Search by name" @keyup="updateSearchedPortfolios($event)"
                    v-model="searchQuery" class="outline-none bg-black" />
                <button v-show="searchQuery !== ''" @click="clearSearch" class="ml-auto">
        ...
        <div class="col-span-6 col-end-13">
            <div class="flex justify-end items-center gap-[15px]">
                ...
                <!-- Current page  -->
                <input type="number" @change="updateShowingPortfolios" aria-label="current page" :max="totalLeaderboardPages"
                    v-model="currentPage" class="py-[4px] pl-[12px] w-[55px] bg-black text-white text-[16px] border border-[#003D3B] focus:outline-none" />

                <!-- Total pages count  -->
                <span class="text-[#C3C7CD] text-[14px]" >of
                    <span class="ml-[10px]">
                ...
                <div class="flex gap-0">
                    ...
                    <button class="px-[14px] bg-[#005A57]" @click="nextPage" >
                        <img src="@/assets/img/left-angle.svg" alt="" class="transform rotate-180" />
                    </button>
                </div>
            </div>
        </div>
