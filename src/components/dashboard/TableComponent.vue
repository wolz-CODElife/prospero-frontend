<template>
	<div class="">
		<table class="table-auto w-full absolute top-[65px]">
			<thead>
				<tr
				...
				<tr
					...
					@click="
						portfolioStore.doSelectPortfolio(portfolio),
							$emit('toggleDisabled')
					"
					class="text-left py-[4px] mx-[28px] border-b border-b-[#2D3035] text-white hover:bg-[#003D3B]"
					:class="[
		...
		<!-- Bottom -->
		<div class="grid grid-cols-12 absolute bottom-[10px] inset-x-[20px]">
			<!-- Search -->
			<div class="col-span-5">
				<div
					class="bg-black text-white text-[13px] border border-[#2D3035] focus:outline-none py-[9px] pl-[28px] pr-[12px] flex items-center gap-x-[24px]"
				>
			...
			<div class="col-span-6 col-end-13">
				<div class="flex justify-end items-center gap-[15px]">
					...
					<input
						...
						v-model="currentPage"
						class="py-[3px] pl-[12px] w-[55px] bg-black text-white text-[13px] border border-[#003D3B] focus:outline-none"
					/>

					<!-- Total pages count  -->
					<span class="text-[#C3C7CD] text-[13px]"
						>of
						<span class="ml-[10px]">
